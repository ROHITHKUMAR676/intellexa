...
function Team() {
  ...
  const leads = [
    ...
    { name: "Priya Krishnan", role: "Web Dev Chapter", initials: "PK" },
    { name: "Aditi Verma", role: "Product Design", initials: "AV" },
  ...
  return (
    <section id="team" style={{ position: "relative", padding: "clamp(80px,12vh,160px) clamp(20px,6vw,80px)", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <Reveal delay={0.05}>
          <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "11px", letterSpacing: "0.35em", textTransform: "uppercase", color: "rgba(130,180,255,0.5)", marginBottom: "32px", textAlign: "center" }}>Chapter Leads</div>
        </Reveal>
